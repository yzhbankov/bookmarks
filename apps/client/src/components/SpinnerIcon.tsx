...
export function SpinnerIcon({ size, color }: SpinnerIconType) {
    switch (size) {
        ...
        case Size.xl:
            return <ExtraLargeSpinnerIcon color={color} />;
        default:
            return <MediumSpinnerIcon color={color} />;
    }
}

SpinnerIcon.propTypes = { size: PropTypes.string };

SpinnerIcon.defaultProps = { size: '' };

function ExtraSmallSpinnerIcon({ color = 'blue' }: IconType) {
    return (
        <svg
            aria-hidden="true"
...
function SmallSpinnerIcon({ color = 'blue' }: IconType) {
    return (
        <svg
            aria-hidden="true"
...
function MediumSpinnerIcon({ color = 'blue' }: IconType) {
    return (
        <svg
            aria-hidden="true"
...
function LargeSpinnerIcon({ color = 'blue' }: IconType) {
    return (
        <svg
            aria-hidden="true"
...
function ExtraLargeSpinnerIcon({ color = 'blue' }: IconType) {
    return (
        <svg
            aria-hidden="true"
            className={`inline w-16 h-16 text-gray-200 animate-spin dark:text-gray-200 fill-${color}-600`}
            viewBox="0 0 100 101"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
        >
